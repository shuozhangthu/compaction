...
x = lsqcurvefit(@sulfate_806_function,x0,depth3,sulfate_data,lb,ub)

figure;
plot(sulfate_806_function(x,depth3),depth3,'linewidth',2)
hold on
scatter(sulfate_data,depth3,'ko')
hold on
set(gca,'Ydir','reverse')
title("Sulfate concentration in pore water (site:806)")
...
save('parameters_su_806.mat', '-struct', 'S'); 
