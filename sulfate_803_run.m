...
legend('t=39.8 m.y., present day','t=35 m.y.','t=30 m.y.','t=25 m.y.','Sulfate Data','Location','SouthEast')
print('sulfate803.jpg','-djpeg','-r600');
...
legend('t=39.8 m.y., present day','t=35 m.y.','t=30 m.y.','t=25 m.y.','Location','SouthEast')
print('G803.jpg','-djpeg','-r600');
